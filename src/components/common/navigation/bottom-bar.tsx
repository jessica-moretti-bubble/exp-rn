import SpinnerIcon from "@assets/images/shared/spinner-outline-circle.svg";
import { BottomTabBarProps } from "@react-navigation/bottom-tabs";
import IconBook from "src/components/svg/icon-book";
import IconCards from "src/components/svg/icon-cards";
import IconShoppingCart from "src/components/svg/icon-shopping-cart";
import IconStar from "src/components/svg/icon-star";
