...
import { GenericProgressBar } from "@/components/common/chart/generic-progress-bar";
import type { Answer, QuizData } from "@/types/model/quiz-data.model";
import { QuizQuestions } from "src/config/quiz.config";
...
const backgroundImages: Record<number, any> = {
  1: require("../../assets/images/quiz/quiz-question-variant-1.jpg"),
  2: require("../../assets/images/quiz/quiz-question-variant-2.png"),
  3: require("../../assets/images/quiz/quiz-question-variant-3.jpg"),
  4: require("../../assets/images/quiz/quiz-question-variant-4.png"),
};
