...
import IconGrayBadge from "src/components/svg/challenge/icon-gray-badge";
import IconGreenBadge from "src/components/svg/challenge/icon-green-badge";
import IconOrangeBadge from "src/components/svg/challenge/icon-orange-badge";
import IconPinkBadge from "src/components/svg/challenge/icon-pink-badge";
import IconRedBadge from "src/components/svg/challenge/icon-red-badge";
