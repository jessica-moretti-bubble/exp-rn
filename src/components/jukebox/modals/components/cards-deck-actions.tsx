...
import IconCheck from "src/components/svg/icon-check";
import IconCopy from "src/components/svg/icon-copy";
import IconCubble from "src/components/svg/icon-cubble";
import IconInfo from "src/components/svg/icon-info";
import IconShopping from "src/components/svg/icon-shopping";
